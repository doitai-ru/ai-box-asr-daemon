...
- Отправка на распознавание **файла**, **сслыки на файл** или **аудиопотока**. 
...
- При обработке файлом (не потока) можно строить "диалог"
- При обработке файла (не потока) можно удалять межканальное эхо (текст, не аудио)
