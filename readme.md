...
- Поддержка моделей распознавания речи: **Vosk** и **GigaAMv2**.
- Отправка на распознавание **файла**, **ссылка на файл**, **файл аудио-потоком** или автоматическое распознавание файлов в директории. 
...
- При обработке можно строить "диалог" с пунктуацией. (Полезно для многоканальных записей, без ограничения на количество каналов!) 
...
BETWEEN_WORDS_PERCENTILE = 80 # Параметр определяет как мелко будет биться текст на предложения при подготовке диалога. 
...
## Работы
- 07 августа 2025 года - оптимизирован код для разумного испольщования памяти GPU и CPU. Теперь размер модели диаризации может быть использован в GPU с памятью от 8 Gb 
